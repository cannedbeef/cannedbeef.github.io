// minor modifications by cannedbeef
...
// MODIFICATION FOR cannedbeef.github.io!!!!!!!!!
DataDir=window.location.origin+'/iframes/cookieclicker/data/';
// MODIFICATION OVER!!!!
	...
	if (!Game.ready)
	{
		var loadLangAndLaunch=function(lang,firstLaunch)
		{
			...
			var launchSteps=[
				...
				function(){
					Game.Launch();
					// MODIFICATION MADE FOR cannedbeef.github.io!!!!!!!!!!!!!!!
					// PREVIOUS LINE WAS:
